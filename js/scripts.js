$( document ).ready(function() {
  ...
  let homeSection = $('#inicio-area');
  let sobreSection = $('#sobre-area');
  let treinosSection = $('#treinos-area');
  let treinadoresSection = $('#treinadores-area');
  let depoimentosSection = $('#depoimentos-area');
  let mainsliderSection = $('#mainSlider');
  ...
  $(navBtn).click(function() {
    ...
    if(btnId == 'inicio-menu') {
      scrollTo = homeSection;
    } else if(btnId == 'sobre-menu') {
      scrollTo = sobreSection;
    } else if(btnId == 'treinos-menu') {
      scrollTo = treinosSection;
    } else if(btnId == 'treinadores-menu') {
      scrollTo = treinadoresSection;
    } else if(btnId == 'depoimentos-menu') {
      scrollTo = depoimentosSection;
    } else if(btnId == 'game-menu') {
      scrollTo = gameSection;
    } else if(btnId == 'carrossel-area') {
      scrollTo = mainsliderSection;
